...
export const Education = () => {
    return (
        <section className={styles.container_education}>
            ...
            <div className={styles.content}>
                ...
                <p className={styles.description}>Cursos sobre desarrollo web (HTML, CSS, Bootstrap, JS, React), desarrollo móvil (React Native) y otros como Git/Github, Firebase, Figma.</p>
            </div>
